...
class Console:
    ...
    def set_window_title(self, title: str) -> bool:
        ...
        Rest software (including the terminal itself, the shell, custom prompts, plugins, etc.)
    ...
    def update_screen(
        ...
        *,
        ...
        Args:
            ...
            region (Region, optional): Region of screen to upload, or None for entire screen. Defaults to None.
...
def _svg_hash(svg_main_code: str) -> str:
    """Returns a unique hash for the given SVG src code.
