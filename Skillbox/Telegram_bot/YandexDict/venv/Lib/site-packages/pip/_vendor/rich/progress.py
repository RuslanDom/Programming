...
class _TrackThread(Thread):
    """A thread to periodically upload progress."""
...
def track(
    ...
    Args:
        ...
        update_period (float, optional): Minimum time (in seconds) between calls to upload(). Defaults to 0.1.
...
class Task:
    ...
    """dict: Arbitrary fields passed in via Progress.upload."""
...
class Progress(JupyterMixin):
    ...
    def wrap_file(
        ...
        *,
        ...
        # upload total of task or create new task
        if task_id is None:
    ...
    def add_task(
        ...
        **fields: Any,
        ...
        Returns:
            TaskID: An ID you can use when calling `upload`.
        """
        with self._lock:
            task = Task(
                self._task_index,
