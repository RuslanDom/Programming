...
LEXERS = {
    ...
    'KconfigLexer': ('pip._vendor.pygments.lexers.configs', 'Kconfig', ('kconfig', 'menuconfig', 'linux-config', 'kernel-config'), ('Kconfig*', '*config_data.in*', 'external.in*', 'standard-modules.in'), ('text/x-kconfig',)),
